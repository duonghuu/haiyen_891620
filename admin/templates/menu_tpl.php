<div class="logo"><a href="index.php" style="display:block;">
    ...
    <ul id="menu" class="nav">
        <li class="dash" id="menu1"><a class=" active" title="" href="index.php">
            ...
            'chinh-sach','huong-dan','khuyen-mai','vi-sao','txtvi-sao',
            ...
            <ul class="sub">
                ...
                <?php phanquyen_menu('Khuyến mãi','news','man','khuyen-mai'); ?>
...
$_GET['com']=='user') echo ' activemenu' ?>" id="menu_cp"><a href="" title="" class="exp">
    ...
    <ul class="sub">
        ...
        <?php phanquyen_menu('Khuyến mãi','title','capnhat','khuyen-mai'); ?>
    </ul>
</li>
</ul>