...
@define ('_sangold','Sân gold');
@define ('_vanchuyen','Vận chuyển');
@define ('_khoihanh','Khởi hành');
@define ('_tournoibat','Tour nổi bật');
@define ('_giatour','Giá tour');
@define ('_gtnu','Nữ');
@define ('_gtnam','Nam');
@define ('_vietnam','Việt Nam');
@define ('_nuocngoai','Nước ngoài');
@define ('_embe','Em bé');
@define ('_emnho','Em nhỏ');
@define ('_sosinh','Sơ sinh');
@define ('_khong','Không');
@define ('_co','Có');
@define ('_danhsachkhachhang','Danh sách khách hàng');
@define ('_loaikhach','Loại khách');
@define ('_dotuoi','Độ tuổi');
@define ('_phongdon','Phòng đơn');
@define ('_visa','Visa');
@define ('_thoigian','Thời gian');
@define ('_socho','Số chỗ');
@define ('_xemtatcacatour','Xem tất cả các tour');
@define ('_tuvanvadatcho','Tư vấn &amp; đặt chỗ');
@define ('_diachivanphong','Địa chỉ văn phòng');
@define ('_tour','Tour');

@define ('_qahuongdan','Hỏi đáp');
@define ('_coffeeandfood','Coffee &amp; food menu');
@define ('_parkmap','Park map');
@define ('_denvoichungtoi','Đến với chúng tôi');
@define ('_email','Email');
@define ('_tieude','Tiêu đề');
@define ('_theodoichungtoi','Theo dõi chúng tôi');
@define ('_noidungguidentabico','Nội dung gửi đến TABICO');
@define ('_tamnhinsumenh','Tầm nhìn &amp; sứ mệnh');
@define ('_bancantuvan','Bạn cần tư vấn?');
...
@define ('_ketnoichungtoi','Kết nối với chúng tôi');
@define ('_gioithieuvecongty','Giới thiệu về công ty');
@define ('_hethongcuahang','Hệ thống cửa hàng');
@define ('_quychequanlyhoatdong','Quy chế quản lý hoạt động');
@define ('_albumanh','Album ảnh');
@define ('_cuahang','Cửa hàng');
@define ('_hinhanhtaimucdong','Hình ảnh tại Mục Đồng');
@define ('_xemthemhinhanh','Xem thêm hình ảnh');
@define ('_hethongbanhmi','Hệ thống banhmithonhiky.net');
@define ('_giomocua','Giờ mở cửa');
@define ('_thucdon','Thực đơn');
@define ('_chuyencua','Chuyện của');
@define ('_huongdandatmon','Hướng dẫn đặt món');
@define ('_thongtinkhuyenmai','Thông tin khuyến mãi');
...
@define ('_duocpham','Dược phẩm');
@define ('_duocmypham','Dược mỹ phẩm');
@define ('_thietbiyte','Thiết bị y tế');
@define ('_muangay','Mua ngay');
@define ('_dangkytuvan','Đăng ký tư vấn');
@define ('_goidebaogia','Gọi để báo giá');
@define ('_chondanhmuc','Chọn danh mục');
@define ('_banchuadangnhap','Bạn chưa đăng nhập');
@define ('_vechungtoi','Về chúng tôi');
@define ('_cackhoahoc','Các khóa học');
@define ('_lichhoc','Lịch học');
@define ('_anhvideo','Ảnh - video');
@define ('_doinetve','Đôi nét về');
@define ('_hoatdongcuachungtoi','Hoạt động của chúng tôi');
@define ('_hocviennoigi','Học viên nói gì');

@define ('_lienhevoichungtoi','Liên hệ với chúng tôi');
@define ('_ykienkhachhang','Ý kiến khách hàng');
@define ('_datphong','Đặt phòng');
@define ('_lapdat','Lắp đặt');
@define ('_laybaogiatufanpage','Lấy báo giá từ fanpage');
@define ('_muahangnhanhlapdattoanquoc','Mua hàng nhanh, lắp đặt toàn quốc');
@define ('_ngonngu','Ngôn ngữ');
@define ('_mangxahoi','Mạng xã hội');
@define ('_hotlinetuvan','Hotline tư vấn');
@define ('_formdatphong','Form đặt phòng');
@define ('_moidem','mỗi đêm');
@define ('_datphongngay','Đặt phòng ngay');
@define ('_motsohinhanh','Một số hình ảnh của các khu tại khách sạn của chúng tôi');

@define ('_nguoilon','Người lớn');

@define ('_ngayalert','Ngày đi phải lớn hơn hoặc bằng ngày đến. Ngày đến hiện tại ');

@define ('_dapungdaydu','Khách sạn chúng tôi đáp ứng đầy đủ dịch vụ, tiện nghi cao cấp nhất');

@define ('_treem','Trẻ em');
@define ('_thongtin','Thông tin');
@define ('_tienichcaocap','Tiện ích cao cấp');
@define ('_album','Album');
@define ('_hoatdong','Hoạt động');
@define ('_hon30nam','Hơn 30 năm');
@define ('_tienich','Tiện ích');
@define ('_tuvanngay','Tư vấn ngay');
@define ('_gioithieuve','Giới thiệu về');
@define ('_giachitu','giá chỉ từ');


@define ('_loaiphong','Loại phòng');
@define ('_cacloaiphong','Các loại phòng');
@define ('_baomatthongtin','Điền đầy đủ thông tin để đặt được phòng mong muốn, mọi thông tin đều bảo mật');
...
@define ('_gocnhanong','Góc nhà nông');
...
@define ('_hotlinedathang','Hotline đặt hàng');
@define ('_bandoduongdi','Bản đồ đường đi');
...
@define ('_thucuabandaduocguidi','Thư của bạn đã được gởi đi');
@define ('_guimailbiloi','Gởi mail bị lỗi');
...
@define ('_chiase','Shares');
@define ('_duonglinkkhongtontai','Đường link này không tồn tại. Vui lòng chuyển sang mục khác <a href="">Về trang chủ</a>. Cảm ơn!');
@define ('_loi404','Lỗi: 404');
...
@define ('_thugon','Thu gọn');
@define ('_traloi','Trả lời');
@define ('_tu30den1000','Bình luận từ 30 đến 1000 ký tự');
@define ('_vuilongnhanguihoanthanh','Vui lòng click vào gửi và hoàn thành');
@define ('_delaithongtin','Vui lòng để lại thông tin của bạn');
@define ('_guivahoantat','Gửi & hoàn tất');
@define ('_nhaptiengvietcodau','Mời bạn thảo luận,vui lòng nhập Tiếng Việt có dấu...');
@define ('_binhluanthanhcong','Gửi bình luận thành công.Chúng tôi sẽ xét duyệt trong thời gian sớm nhất.Cảm ơn!');
?>