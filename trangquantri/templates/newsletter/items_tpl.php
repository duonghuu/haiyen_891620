...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <tr style="text-align:center">
        ...
        <?php /*         
        <td class="sortCol"><div>Địa chỉ<span></span></div></td>
        <td class="sortCol"><div>Quan tâm<span></span></div></td>
    ...
    <?php for($i=0, $count=count($items); $i<$count; $i++){?>
       ...
       <?php /*  
         ...
         <?php /* 
            <td  style="width:60%;" align="center"><b><?=$items[$i]['diachi']?></b></td>
            <td  style="width:60%;" align="center"><b><?=$items[$i]['quantam']?></b></td>
